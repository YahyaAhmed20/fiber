...
class ContactInquiry(models.Model):
    ...
    INQUIRY_TYPES = [
    ('quote', _('Request a Quote')),              # طلب عرض سعر
    ('technical', _('Technical Support')),         # دعم فني
    ('custom', _('Custom Cable Solutions')),       # حلول كابلات مخصصة
    ('partnership', _('Partnership Inquiry')),     # ✅ أضفنا ده
    ('general', _('General Inquiry')),             # ✅ أضفنا ده
    ('other', _('Other')),                         # أخرى
]
